                                ...
                                <div class="card card-bordered h-100">
                                    <div class="card-inner">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($bizprofile as $profile)
                                                <form action="{{ route('bizplan.manage', ['id' => $profile->profile_id]) }}" method="GET">

                                                <tr>
                                                    <th scope="row">{{ $profile->id  }}</th>
                                                    <td>{{ $profile->business_name }}
                                                        <input type="text" name="profile_id"  value="{{ $profile->profile_id }}"  id="">
